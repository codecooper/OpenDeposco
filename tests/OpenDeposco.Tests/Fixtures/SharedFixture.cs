...
namespace OpenDeposco.Tests.Fixtures;
...
public class SharedFixture : IDisposable
{
    ...
    public SharedFixture()
    {
        try
        {
            ...
            var settings = JsonSerializer.Deserialize<OpenDeposcoConfig>(apiKeyJson) ?? new OpenDeposcoConfig();
    ...
    public ApiKey ApiKey { get; set; } = new(new OpenDeposcoConfig());
